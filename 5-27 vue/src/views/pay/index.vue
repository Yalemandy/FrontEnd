    ...
    <div class="address">
      ...
      <div class="info" v-if="true">
        <div class="info-content">
          ...
          <span class="mobile">{{ orderList.phone }}</span>
        </div>
        <div class="info-address">
          {{ orderList.region.province }} {{ orderList.region.city }} {{ orderList.region.region }} {{ orderList.detail }}
        </div>
      </div>
...
export default {
  ...
  async created(){
    let a = await getOrderList()
    this.orderList = a.list[0]
  }
}
</script>
